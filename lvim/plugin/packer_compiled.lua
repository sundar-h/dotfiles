...
_G.packer_plugins = {
  ...
  ["defx.nvim"] = {
    loaded = true,
    path = "/Users/sanghaifa/.local/share/lunarvim/site/pack/packer/start/defx.nvim",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dashboard-nvim', 'which-key.nvim', 'barbar.nvim', 'toggleterm.nvim', 'telescope-project.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
vim.cmd [[au WinScrolled * ++once lua require("packer.load")({'neoscroll.nvim'}, { event = "WinScrolled *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-cursorword'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'dial.nvim', 'gitsigns.nvim', 'lsp-colors.nvim', 'lsp-rooter.nvim', 'vim-sanegx', 'lsp_signature.nvim', 'nvim-bqf', 'nvim-lastplace', 'nvim-spectre', 'Comment.nvim', 'vim-easymotion', 'todo-comments.nvim', 'telescope-fzy-native.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
